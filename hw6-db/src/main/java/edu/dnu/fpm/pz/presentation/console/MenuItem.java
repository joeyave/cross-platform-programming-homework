package edu.dnu.fpm.pz.presentation.console;
...
public class MenuItem {
	...
	public MenuItem(String label, Object obj, String target, Class[] params, Object[] args) {
		this.label = label;
		this.obj = obj;
		this.target = target;
		this.params = params;
	...
	void invoke() {
		...
		try {
			Method method = obj.getClass().getMethod(target, params);
